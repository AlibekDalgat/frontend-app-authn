...
export const AUTH_PARAMS = ['course_id', 'enrollment_action', 'course_mode', 'email_opt_in', 'purchase_workflow', 'next', 'res_email', 'register_for_free', 'track', 'is_account_recovery', 'variant', 'host', 'cta'];
